...
user_route.get('/productStatusCancel', isLogged , isBlocked ,  orderController.productStatusCancel)
user_route.get('/generateInvoice/:orderId', isLogged , isBlocked , orderController.invoice)

user_route.post('/returnOrderProduct', isLogged , isBlocked ,orderController.returnProductOrder)
